...
class TestCapabilityFor:
    ...
    def test_every_classified_tool_has_a_routing_answer(self):
        ...
        table exists to prevent (and _get_graph_client fails closed on).
        Only the "account" group, the name-split "delta" group, and genuinely
        unknown names may answer None.
        """
