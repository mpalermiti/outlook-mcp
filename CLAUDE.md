...
- `src/outlook_mcp/routing.py` — capability routing: tool name -> capability -> account (`_get_graph_client` consults it; fails closed on multi-account installs when the tool name is unreadable)
